...
public class SwaggerConfig {
    ...
    public Docket getDocket(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .securitySchemes(Arrays.asList(basicAutoScheme()));
    }

    private SecurityScheme basicAutoScheme(){
    ...
    private SecurityReference basicAutoReference() {
        return new SecurityReference("basicAuth", new AuthorizationScope[0]);
    }

    private SecurityContext  getSecurityContext() {
        return SecurityContext.builder().securityReferences(Arrays.asList(basicAutoReference()))
                .build();
    }
